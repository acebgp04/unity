	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="list" params="[team:session.getAttribute('team'), subTeam:session.getAttribute('subTeam')]"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="create-player" class="content scaffold-create" role="main">
			...
			<g:uploadForm url="[resource:playerInstance, action:'save']" >
				<fieldset class="form">
